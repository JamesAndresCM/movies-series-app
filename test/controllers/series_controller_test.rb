...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post series_index_url, params: { series: { category_id: @series.category_id, director: @series.director, name: @series.name, release_date: @series.release_date, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { category_id: @series.category_id, director: @series.director, name: @series.name, release_date: @series.release_date, year: @series.year } }
